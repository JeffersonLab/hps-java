...
public class MnUserParameters {
     ...
     * will be the same as in the double[] in the FCNBase.valueOf(). That means
     * the first parameter the user adds gets index 0, the second index 1, and
     * so on. When calculating the function value inside FCN, MINUIT will call
     * FCNBase.valueOf() with the elements at their respective positions.
     */
