...
public abstract class MnApplication {
    ...
    /**
     * By default if the function to be minimized implements FCNGradientBase
     * then the analytical gradient provided by the function will be used. Set
     * this to <CODE>false</CODE> to disable this behaviour and force numerical
