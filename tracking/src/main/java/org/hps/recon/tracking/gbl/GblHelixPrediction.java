...
public class GblHelixPrediction {
    ...
    // nDir is a 3-vector
    // aPos is a 3-vector
    public GblHelixPrediction(double sArc, double[] aPred, double[] tDir, double[] uDir, double[] vDir, double[] nDir, double[] aPos) {

        self = GblInterface.INSTANCE.GblHelixPredictionCtor(sArc, aPred, tDir, uDir, vDir, nDir, aPos);
    }
