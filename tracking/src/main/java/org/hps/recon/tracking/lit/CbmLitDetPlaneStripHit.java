 ...
 * @version $Id:
 */
public class CbmLitDetPlaneStripHit extends CbmLitStripHit implements Comparable {

    public CbmLitDetPlaneStripHit(DetectorPlane p) {
        SetHitType(LitHitType.kLITSTRIPHIT);
        _detPlane = p;
    }

    public CbmLitDetPlaneStripHit(DetectorPlane p, double u, double du) {
        SetHitType(LitHitType.kLITSTRIPHIT);
        _detPlane = p;
        fU = u;
        fDu = du;
...
//    }
    ...
    public int compareTo(Object o) {
        ...
        DetectorPlane that = ((CbmLitDetPlaneStripHit) o).GetPlane();
