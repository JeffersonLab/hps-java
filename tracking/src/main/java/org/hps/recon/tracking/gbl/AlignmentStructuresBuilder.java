...
public class AlignmentStructuresBuilder {
    ...
    public AlignmentStructuresBuilder(List<SiSensor> sensors) {
        ...
        for (SiSensor sensor : sensors) {
            ...
            AlignableVolume av_sensor = new AlignableVolume(sensor.getName() + "_AV", ((HpsSiSensor) sensor).getGeometry().getLocalToGlobal(), null, null,
                    ((HpsSiSensor) sensor).getMillepedeId());
