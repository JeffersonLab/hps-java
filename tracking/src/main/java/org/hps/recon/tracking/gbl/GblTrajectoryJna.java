...
public class GblTrajectoryJna {
    ...
    public GblTrajectoryJna(List<GblPointJna> points, boolean flagCurv, boolean flagU1dir, boolean flagU2dir) {
        ...
        self = GblInterface.INSTANCE.GblTrajectoryCtorPtrArray(ppoints, points.size(), flagCurv ? 1 : 0, flagU1dir ? 1 : 0, flagU2dir ? 1 : 0);
    ...
    public GblTrajectoryJna(List<GblPointJna> points, int aLabel, Matrix seed, boolean flagCurv, boolean flagU1dir, boolean flagU2dir) {
        ...
        self = GblInterface.INSTANCE.GblTrajectoryCtorPtrArraySeed(ppoints, points.size(), aLabel, seedArray, flagCurv ? 1 : 0, flagU1dir ? 1 : 0,
                flagU2dir ? 1 : 0);
    ...
    public GblTrajectoryJna(List<Pair<List<GblPointJna>, Matrix>> PointsAndTransList) {
        ...
        self = GblInterface.INSTANCE.GblTrajectoryCtorPtrComposed(ppoints_1, npoints_1, trafo_1, ppoints_2, npoints_2, trafo_2);
    }
    ...
    public void getMeasResults(int aLabel, int numData[], List<Double> aResiduals, List<Double> aMeasErrors, List<Double> aResErrors,
            List<Double> aDownWeights) {
