...
//TODO Add enums for the track parameters
    ...
    // copy constructor
    public CbmLitTrackParam(CbmLitTrackParam p) {
        SetStateVector(p.GetStateVector());
        SetZ(p.GetZ());
        SetCovMatrix(p.GetCovMatrix());
    }

    public void copyFrom(CbmLitTrackParam p) {
        SetStateVector(p.GetStateVector());
        SetZ(p.GetZ());
        SetCovMatrix(p.GetCovMatrix());
    }
...
//      nz = unit.Z();
    ...
    public String toString() {
        ...
        ss.append("TrackParam: pos=(" + fX + "," + fY + "," + fZ
