...
public class MilleBinaryJna {
    ...
    public interface MilleBinaryInterface extends Library {
        ...
        //Pointer MilleBinaryCtor(char[] fileName, int filenamesize, int doublePrec, int aSize);
        Pointer MilleBinaryCtor(String fileName, int filenamesize, int doublePrec, int aSize);
    ...
    public MilleBinaryJna(String fileName) {
        self = MilleBinaryInterface.INSTANCE.MilleBinaryCtor(fileName,fileName.length(), 0, 200000);
    }
