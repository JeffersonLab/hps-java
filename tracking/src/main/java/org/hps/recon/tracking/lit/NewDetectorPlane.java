...
public class NewDetectorPlane {
    ...
    public NewDetectorPlane(int id, Matrix m, double[] pos, double[] s) {
        _id = id;
        _rotMat = m;
        _r0 = pos;
        _sigs = s;
    ...
    public NewDetectorPlane(int id, double[] rot, double[] pos, double[] s) {
        _id = id;
...
//        System.out.println("updating NewDetectorPlane " + _id + " position");
...
//        System.out.println("new position " + Arrays.toString(_r0));
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("NewDetectorPlane " + _name + " " + _id + " : \n");
...
//        System.out.println("local "+g2l.times(tmp));
        Matrix local = _rotMat.times(tmp);
//        System.out.println("local " + local);
        return new BasicHep3Vector(local.get(0, 0), local.get(1, 0), local.get(2, 0));
    }
