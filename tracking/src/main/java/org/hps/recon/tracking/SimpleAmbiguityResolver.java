...
public class SimpleAmbiguityResolver extends AmbiguityResolver {
     ...
     * Constructor
     *
     * @param inputTracks : all track collections
     * @param mode : remove duplicates, remove partials, remove shared, remove poor scoring tracks, all the above
    ...
    // Setters, getters
    /**
     * @param shareThreshold : max number of shared hits that any operable tracks can share with each other
     */
    ...
    /**
     * @param scoreThreshold : min acceptable score for a track
     */
    ...
    /**
     * @return shareThreshold : max number of shared hits that any operable tracks can share with each other
     */
    ...
    /**
     * @param mode : remove duplicates, remove partials, remove shared, advanced ATLAS-style
     */
