 ...
 * @author ngraf
 */
public class RK4TrackExtrapolatorTest extends TestCase {

    /**
     * Test of Extrapolate method, of class RK4TrackExtrapolator.
     */
    public void testRK4TrackExtrapolator() {
        ...
        RK4TrackExtrapolator extrap = new RK4TrackExtrapolator(field);
        ...
        Hep3Vector eta = new BasicHep3Vector(0., 0., 1.);
        ...
        DetectorPlane p = new DetectorPlane("p1", pos, eta, l2g, g2l, x0, X, unmeasDim, Y, measDim);
        ZTrackParam planePar = new ZTrackParam(parIn);
...
class TestMagneticField implements Field {
...
class CircleFitter {
    ...
    public CircleFit propagatefit(double x, double y) {
        double DIRTX = cos(_phi);
        double DIRTY = sin(_phi);
        double SINF = sin(_phi);
        double COSF = cos(_phi);
