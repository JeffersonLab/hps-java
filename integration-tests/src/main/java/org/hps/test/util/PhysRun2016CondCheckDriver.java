 ...
 */
public class PhysRun2016CondCheckDriver extends Driver {
    
    private static Logger LOG = Logger.getLogger(PhysRun2016CondCheckDriver.class.getName());
    ...
    public void detectorChanged(Detector detector) {
        ...
        LOG.info("Checking collection IDs of PhysRun2016 conditions...");
        ...
        TestCase.assertEquals("SvtShapeFitParametersCollection has wrong collection ID.", 1961, svtShapeFit.getCollectionId());
        ...
        TestCase.assertEquals("EcalChannelCollection has wrong collection ID.", 2017, ecalChannels.getCollectionId());

        EcalGainCollection ecalGains = mgr.getCachedConditions(EcalGainCollection.class, "ecal_gains").getCachedData();
        TestCase.assertEquals("EcalGainCollection has wrong collection ID.", 2976, ecalGains.getCollectionId());
        ...
        TestCase.assertEquals("EcalCalibrationCollection has wrong collection ID.", 1970, ecalCalib.getCollectionId());
        ...
        TestCase.assertEquals("EcalTimeShiftCollectio has wrong collection ID.", 2018, ecalTimeShifts.getCollectionId());
        ...
        TestCase.assertEquals("SvtBiasConstantCollection has wrong collection ID.", 2545, svtBiasConstants.getCollectionId());
        ...
        TestCase.assertEquals("SvtMotorPositionCollection has wrong collection ID.", 2783, svtMotorPositions.getCollectionId());
        ...
        TestCase.assertEquals("SvtTimingConstantsCollection has wrong collection ID.", 1974, svtTimingConstants.getCollectionId());
        ...
        LOG.info("Done checking collection IDs for PhysRun2016 conditions!");
    }
