...
public class ConditionsIT extends TestCase {
    ...
    public void testEvioToLcioEngRun2015() {
        File inputFile = TestUtil.downloadTestFile("run5772_integrationTest.evio");
    ...
    public void testLcioReconEngRun2015() {
        File inputFile = TestUtil.downloadTestFile("run_5772_data_only.slcio");
    ...
    public void testEvioToLcioPhysRun2016() {
        File inputFile = TestUtil.downloadTestFile("hps_007457_1000.evio.0");
        File outputFile = new TestOutputFile(ConditionsIT.class, "EvioToLcioEngRun2015");
    ...
    public void testEvioToLcioTestRun() {
        File inputFile = TestUtil.downloadTestFile("hps_001306_1000.evio.0");
    ...
    */
    ...
    public void testMCReconUserConditions() {
        File inputFile = TestUtil.downloadTestFile("tritrig_EngRun2015_readout.slcio");
        File outputFile = new TestOutputFile(ConditionsIT.class, "MCReconDefaultConditions");
        JobManager job = new JobManager();
    ...
    public void testReadoutSim() {
        File inputFile = TestUtil.downloadTestFile("tritrig_EngRun2015_filt.slcio");
    ...
    public void testMCReconL0() {
        File inputFile = TestUtil.downloadTestFile("tritrig_L0_readout.slcio");
