...
/**
 * Test Moller reconstruction for 2016 physics run
 */
public class PhysRun2016MollerReconKalmanTest extends ReconTest {
    ...
    public PhysRun2016MollerReconKalmanTest() {
        super(PhysRun2016MollerReconKalmanTest.class,
                DETECTOR,
                TEST_FILE_NAME,
                STEERING,
                NEVENTS,
    ...
    private static class PlotDriver extends RefDriver {
        ...
        double thetaSumCut = 0.0475;
        double trackChi2NdfCut = 8.;
        ...
        IHistogram1D trkNhitsHist_UnconstrainedMollerVertices = aida.histogram1D("UnconstrainedMollerVertices/Moller Track Number of Hits", 15, -0.5, 14.5);
        ...
        IHistogram1D trkNhitsHist_BeamspotConstrainedMollerVertices = aida.histogram1D("BeamspotConstrainedMollerVertices/Moller Track Number of Hits", 15, -0.5, 14.5);
        ...
        IHistogram1D trkNhitsHist_TargetConstrainedMollerVertices = aida.histogram1D("TargetConstrainedMollerVertices/Moller Track Number of Hits", 15, -0.5, 14.5);
