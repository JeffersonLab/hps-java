    ...
    public static void swapData(ByteBuffer srcBuf, ByteBuffer destBuf,
        ...
        while (srcIndex < srcEndIndex) {
            ...
            // 32-bit
                ...
                while (srcIndex < b32EndIndex) {
                    // buffers are of opposite endianness so putInt will automagically swap
                    destBuf.putInt(destIndex, srcBuf.getInt(srcIndex));
                    srcIndex  += 4;
                    destIndex += 4;
                }
            ...
            // 8 bits
                ...
                if (!inPlace) {
                    ...
                    srcBuf.position(srcIndex);
                    srcBuf.get(b, 0, ncnf);
                    destBuf.position(destIndex);
