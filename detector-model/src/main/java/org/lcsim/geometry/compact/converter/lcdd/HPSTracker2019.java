...
import org.lcsim.geometry.compact.converter.HPSTracker2019LCDDBuilder;
import org.lcsim.geometry.compact.converter.HPSTrackerBuilder;
import org.lcsim.geometry.compact.converter.HPSTrackerLCDDBuilder;
import org.lcsim.geometry.compact.converter.lcdd.util.LCDD;
import org.lcsim.geometry.compact.converter.lcdd.util.SensitiveDetector;

public class HPSTracker2019 extends HPSTracker2014v1 {
    public HPSTracker2019(Element node) throws JDOMException {
        super(node);
    }
    ...
    protected HPSTrackerLCDDBuilder initializeBuilder(LCDD lcdd,
        ...
        return new HPSTracker2019LCDDBuilder(_debug, node, lcdd, sens);
    }
