...
public class LCDDSurveyVolume extends SurveyVolumeImpl {
    ...
    public LCDDSurveyVolume(SurveyVolume surveyVolume, Volume volume) {
        super(surveyVolume);
        if (isDebug())
            System.out.printf("%s: constructing LCDD object %s with volume name %s\n", this.getClass().getSimpleName(),
                    surveyVolume.getName(), volume.getName());
        setVolume(volume);
        if (isDebug())
    ...
    public LCDDSurveyVolume(SurveyVolume surveyVolume, LCDD lcdd, LCDDSurveyVolume mother) {
        super(surveyVolume);
        if (isDebug())
            System.out.printf("%s: constructing LCDD object %s with mother %s\n", this.getClass().getSimpleName(),
                    surveyVolume.getName(), mother == null ? "null" : mother.getName());
        this.lcdd = lcdd;
        setMother(mother);
    ...
    public void setPositionAndRotation(SurveyVolume base) {
        ...
        if (isDebug()) {
            ...
            System.out.printf("%s: box_center_tracking_xcheck  %s (for %s)\n", this.getClass().getSimpleName(),
                    box_center_tracking_xcheck.toString(), base.getName());
        }
