...
public class HPSTestRunTracker2014LCDDBuilder extends HPSTrackerLCDDBuilder {
    ...
    public void build(Volume worldVolume) {
        ...
        LCDDSurveyVolume basePlateGeometry = new LCDDSurveyVolume(_builder.getSurveyVolume(BasePlate.class), lcdd,
                baseSurveyVolume);
        ...
        LCDDSurveyVolume cSupportGeometry = new LCDDGhostSurveyVolume(_builder.getSurveyVolume(CSupport.class),
                baseSurveyVolume);
        add(cSupportGeometry);
        LCDDSurveyVolume supportBottomGeometry = new LCDDGhostSurveyVolume(
                _builder.getSurveyVolume(SupportBottom.class), baseSurveyVolume);
        add(supportBottomGeometry);
        LCDDSurveyVolume supportPlateBottomGeometry = new LCDDSurveyVolume(
                _builder.getSurveyVolume(SupportPlateBottom.class), lcdd, baseSurveyVolume);
        add(supportPlateBottomGeometry);
        LCDDSurveyVolume supportTopGeometry = new LCDDGhostSurveyVolume(_builder.getSurveyVolume(SupportTop.class),
                baseSurveyVolume);
        add(supportTopGeometry);
        LCDDSurveyVolume supportPlateTopGeometry = new LCDDSurveyVolume(
                _builder.getSurveyVolume(SupportPlateTop.class), lcdd, baseSurveyVolume);
