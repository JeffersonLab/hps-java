...
public class HPSTestRunTracker2014GeometryDefinition extends HPSTrackerGeometryDefinition {
    ...
    protected static final double target_pos_wrt_base_plate_y = 80.55; // from Tim's sketchup
    ...
    public void build() {
        ...
        SupportBottom supportBottom = new SupportBottom("support_bottom", base, alignmentCorrectionSupportBottom,
                cSupport);
        ...
        SupportPlateBottom supportPlateBottom = new SupportPlateBottom("support_plate_bottom", base, supportBottom,
                "Aluminum");
    ...
    public static class CSupport extends SurveyVolume {
        ...
        private void calcAndSetFlatPos() {
            if (use30mradRotation) {
                ...
                Rotation rot1_csup = new Rotation(new Vector3D(vee_pos_csup_pin_bottom_x - ball_pos_csup_pin_bottom_x,
                        vee_pos_csup_pin_bottom_y - ball_pos_csup_pin_bottom_y, vee_pos_csup_pin_bottom_z
                                - ball_pos_csup_pin_bottom_z), new Vector3D(1, 0, 0));
    ...
    public static class SupportTop extends SurveyVolume {
        ...
        protected void setPos() {
            ...
            setBallPos(SupportBottom.ball_pos_csup_bearings_bottom_x, SupportBottom.ball_pos_csup_bearings_bottom_y,
                    ball_pos_csup_bearings_top_z);
            setVeePos(SupportBottom.vee_pos_csup_bearings_bottom_x, SupportBottom.vee_pos_csup_bearings_bottom_y,
                    ball_pos_csup_bearings_top_z);
            // build the rotation to find the proper location of the flat
            Rotation rot_csup_top = new Rotation(RotationOrder.XYZ, SupportPlateTop.support_plate_top_tilt_angle, 0.0,
                    0.0);

            // apply to flat local position (as for bottom it is an arbitrary
            // offset)
            Vector3D flat_pos_csup_bearings_top_3D_rot = rot_csup_top.applyTo(new Vector3D(0.0, 10.0, 0.0));
        ...
        protected void setCenter() {
            setCenter(support_top_width / 2.0 + 1.0, support_top_length / 2.0 + (17.00 - 10.50 / 2.0), -1.0
    ...
    public static class SupportBottom extends SurveyVolume {
        ...
        protected static final double support_bottom_height = SupportPlateBottom.support_plate_bottom_height
                - SupportPlateBottom.support_plate_pocket_depth + TestRunModuleL13.module_box_L13_width
                + SupportPlateBottom.pedestal_height_L1;

        public SupportBottom(String name, SurveyVolume mother, AlignmentCorrection alignmentCorrection,
                SurveyVolume referenceGeom) {
            super(name, mother, alignmentCorrection, referenceGeom);
            init();
        }
        ...
        protected void setPos() {
            ...
            // build the rotation to find the proper location of the flat
            Rotation rot_csup = new Rotation(RotationOrder.XYZ, SupportPlateBottom.support_plate_bottom_tilt_angle,
                    0.0, 0.0);
            // apply to flat local position
            Vector3D flat_pos_csup_bearings_bottom_3D_rot = rot_csup.applyTo(new Vector3D(0.0, 10.0, 0.0));
            // translate
            ...
            // make vectors
            setBallPos(ball_pos_csup_bearings_bottom_x, ball_pos_csup_bearings_bottom_y,
            ...
            setFlatPos(flat_pos_csup_bearings_bottom_x, flat_pos_csup_bearings_bottom_y,
        ...
        protected void setCenter() {
            setCenter(support_bottom_width / 2.0 + 1.0, support_bottom_length / 2.0 + (17.00 - 10.50 / 2.0),
                    support_bottom_height / 2.0 - (12.70 - 6.66 - 1.34));
        }
    ...
    public static class SupportPlateBottom extends SupportPlate {
        ...
        protected void setCenter() {
            setCenter(support_plate_bottom_width / 2.0, support_plate_bottom_length / 2.0, -1.0
    ...
    public static abstract class TestRunModule extends BaseModule {
        ...
        protected void setPos() {
            ...
            if (isBottom()) {
                switch (getLayer()) {
                    case 1:
                        ballPos = new BasicHep3Vector(25.0, 661.1, SupportPlateBottom.pedestal_height_L1
                                - SupportPlateBottom.support_plate_pocket_depth);
                        veePos = new BasicHep3Vector(95.0, 661.1, SupportPlateBottom.pedestal_height_L1
                                - SupportPlateBottom.support_plate_pocket_depth);
                        flatPos = new BasicHep3Vector(60.0, 667.10, SupportPlateBottom.pedestal_height_L1
                                - SupportPlateBottom.support_plate_pocket_depth);
                        break;
                    case 2:
                        ballPos = new BasicHep3Vector(25.0, 561.1, SupportPlateBottom.pedestal_height_L2
                                - SupportPlateBottom.support_plate_pocket_depth);
                        ...
                        break;
                    case 3:
                        ballPos = new BasicHep3Vector(25.0, 461.1, SupportPlateBottom.pedestal_height_L3
                                - SupportPlateBottom.support_plate_pocket_depth);
                        veePos = new BasicHep3Vector(95.0, 461.1, SupportPlateBottom.pedestal_height_L3
                                - SupportPlateBottom.support_plate_pocket_depth);
                        flatPos = new BasicHep3Vector(60.0, 467.10, SupportPlateBottom.pedestal_height_L3
                                - SupportPlateBottom.support_plate_pocket_depth);
                        break;
                    case 4:
                        ballPos = new BasicHep3Vector(25.0, 261.1, SupportPlateBottom.pedestal_height_L4
                                - SupportPlateBottom.support_plate_pocket_depth);
                        veePos = new BasicHep3Vector(95.0, 261.1, SupportPlateBottom.pedestal_height_L4
                                - SupportPlateBottom.support_plate_pocket_depth);
                        flatPos = new BasicHep3Vector(60.0, 267.10, SupportPlateBottom.pedestal_height_L4
                                - SupportPlateBottom.support_plate_pocket_depth);
                        break;
                    case 5:
                        ballPos = new BasicHep3Vector(25.0, 61.1, SupportPlateBottom.pedestal_height_L5
                                - SupportPlateBottom.support_plate_pocket_depth);
                        veePos = new BasicHep3Vector(95.0, 61.1, SupportPlateBottom.pedestal_height_L5
                                - SupportPlateBottom.support_plate_pocket_depth);
                        flatPos = new BasicHep3Vector(60.0, 67.10, SupportPlateBottom.pedestal_height_L5
                                - SupportPlateBottom.support_plate_pocket_depth);
                        break;
                    default:
            ...
            /*
             * // walk through the reference volumes if(referenceGeom!=null) { for(SurveyVolume ref : referenceGeom) { if(debug) { System.out.printf("%s: survey positions before ref %s transform\n" ,this.getClass().getSimpleName(),ref.getName()); printSurveyPos(); } if(debug) System.out.printf("%s: Ref %s coord\n%s\n",this.getClass ().getSimpleName(), ref.getName(),ref.getCoord().toString()); ref.getCoord().getTransformation().transform(ballPos); ref.getCoord().getTransformation().transform(veePos); ref.getCoord().getTransformation().transform(flatPos); if(debug) { System.out.printf("%s: survey positions after ref %s transform\n" ,this.getClass().getSimpleName(),ref.getName()); printSurveyPos(); } } }
             */
    ...
    public static abstract class BaseModule extends SurveyVolume {
        ...
        public BaseModule(String name, SurveyVolume mother, AlignmentCorrection alignmentCorrection, int layer,
                String half) {
            super(name, mother, alignmentCorrection);
            setLayer(layer);
            setHalf(half);
    ...
    public abstract static class TestRunHalfModule extends BaseModule {
        ...
        protected static final double dist_sensor_center_to_coldblock_hole_vdir = (180.0 - 30.0 + (33.75 - 5.0))
                - Sensor.length / 2.0;
        protected static final double half_module_thickness = TestRunHalfModule.getHybridThickness()
                + TestRunHalfModule.getCFThickness() + HalfModuleLamination.thickness;
        ...
        public TestRunHalfModule(String name, SurveyVolume mother, AlignmentCorrection alignmentCorrection, int layer,
                String half) {
        ...
        protected void setCenter() {
            ...
            double box_center_local_y = -Sensor.getSensorThickness() / 2.0 - HalfModuleLamination.thickness
    ...
    public static class TestRunHalfModuleAxial extends TestRunHalfModule {
        ...
        public TestRunHalfModuleAxial(String name, SurveyVolume mother, AlignmentCorrection alignmentCorrection,
                int layer, String half) {
            super(name, mother, alignmentCorrection, layer, half);
            init();
        }
        ...
        protected void setPos() {
            ...
            double ball_pos_halfmod_local_y = -1.0
                    * (coldBlockThick / 2.0 + TestRunHalfModule.getCFThickness() + HalfModuleLamination.thickness + Sensor
    ...
    public static class TestRunHalfModuleStereo extends TestRunHalfModule {
        ...
        public TestRunHalfModuleStereo(String name, SurveyVolume mother, AlignmentCorrection alignmentCorrection,
                int layer, String half) {
            super(name, mother, alignmentCorrection, layer, half);
            if (layer <= 3)
                stereo_angle = -0.1;
        ...
        protected void setPos() {
            ...
            ball_pos_halfmod_local_y = -1.0
                    * (-1.0 * (coldBlockThick / 2.0 + TestRunHalfModule.getCFThickness()
                            + HalfModuleLamination.thickness + Sensor.getSensorThickness() / 2.0));
    ...
    public static class CarbonFiber extends HalfModuleComponent {
        ...
        protected void setPos() {
            ...
            final double ball_pos_cf_local_z = -1
                    * (Sensor.getSensorThickness() / 2.0 + HalfModuleLamination.thickness + TestRunHalfModule
                            .getCFThickness() / 2.0);
    ...
    protected TestRunHalfModuleAxial createTestRunHalfModuleAxial(String volName, BaseModule mother,
    ...
    protected TestRunHalfModuleStereo createTestRunHalfModuleStereo(String volName, BaseModule mother,
            AlignmentCorrection alignmentCorrection, int layer, String half) {
