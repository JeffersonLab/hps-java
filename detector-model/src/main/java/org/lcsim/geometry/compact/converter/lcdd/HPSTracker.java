    ...
    private void makeModuleComponents(Volume moduleVolume, ModuleParameters moduleParameters, SensitiveDetector sd,
        ...
        for (ModuleComponentParameters component : moduleParameters) {
            ...
            if (sensitive) {
                ...
                /*
                 * if (sensorX > moduleX) throw new RuntimeException("Sensor X dimension " + sensorX + " is too big for module."); if (sensorY > moduleY) throw new RuntimeException("Sensor Y dimension " + sensorY + " is too big for module.");
                 */
