...
public final class Geant4Position {
    ...
    /*
     * calculates Tait-Bryan angles for the object orientation defined by initial and final state vectors throws
     * arithmetical exception if the phi angle is calculated wrong or 0
     */
    ...
    public String toString() {
        return ("\"Crys Center coordinates:\\t\"" + this.centerPoint.toString() + "Tait Brian angles phi = "
                + Math.toDegrees(this.taitbriangles[0]) + "\t theta = " + Math.toDegrees(this.taitbriangles[1])
                + "\t psi = " + Math.toDegrees(this.taitbriangles[2]) + "\n");
    }
