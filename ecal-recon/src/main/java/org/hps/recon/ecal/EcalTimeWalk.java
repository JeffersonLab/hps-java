...
public final class EcalTimeWalk {
    ...
    private static final double[] pars = {3.64218e+01, -4.60756e+02, 9.18743e+03, 3.73873e+01, -6.57130e+01,
            1.07182e+02};
    ...
    public static final double correctTimeWalk(double time, double energy) {
        final double poly1 = pars[0] + pars[1] * energy + pars[2] * energy * energy;
        final double poly2 = pars[3] * energy + pars[4] * energy * energy + pars[5] * Math.pow(energy, 4);
     ...
     */
    private static final double[] par = {0.9509, -33.21, 0.2614, -0.9128, 0.6251};
