...
/**
 * This class handles the cluster energy correction for the 2021 run, to include
 * edge corrections and sampling fractions derived from data.
 */
public final class ClusterEnergyCorrection2021 {

    private static final Logger LOG = Logger.getLogger(ClusterEnergyCorrection2021.class.getName());

    public static String name = "ClusterEnergyCorrection2021";
    ...
    private static void loadDataCorrectionParameters() {
        String fname;
        fname = "2021SF_parameters_data.dat";
        LOG.config("Loading resource data: " + fname);
        java.io.InputStream fis = ClusterEnergyCorrection2021.class.getResourceAsStream(fname);
        ...
        try {
            ...
            if (arrOfStr.length != 1) {
                throw new RuntimeException("Error reading resource file 2021SF_parameters_data.dat first line");
            }
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (arrOfStr.length != 3) {
                    throw new RuntimeException("Error reading resource file 2021SF_parameters_data.dat");
                }
    ...
    private static void loadDataFromResourceFile(int pdg) {
        ...
        fname = "2021SF_MC_parameters_" + pname + ".dat";
