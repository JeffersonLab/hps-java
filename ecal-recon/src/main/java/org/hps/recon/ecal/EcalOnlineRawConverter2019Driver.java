 ...
 * {@link org.lcsim.event.RawCalorimeterHit} and
...
public class EcalOnlineRawConverter2019Driver extends Driver {
     ...
     * {@link org.lcsim.event.CalorimeterHit} with energy (GeV) and ns time
     * information.
     */
    ...
    /**
     * Sets the input raw hit data LCIO collection name. Depending on the driver
     * configuration, this could be either a collection of
     * {@link org.lcsim.event.RawTrackerHit} objects for mode-1 data or
     * {@link org.lcsim.event.RawCalorimeterHit} objects for mode-3 and mode-7 data.
     * 
