 ...
 */
public class HpsReconParticleDriver2019 extends ReconParticleDriver {
    
    private Logger LOGGER = Logger.getLogger(HpsReconParticleDriver2019.class.getPackage().getName());
    ...
    public HpsReconParticleDriver2019() {
        super();
    }
    ...
    public void setUseInternalVertexXYPositions(boolean b) {
        ...
        LOGGER.warning("The method HpsReconParticleDriver2019.setUseInternalVertexXYPositions() is deprecated.  Use setUseBeamPositionConditions() instead.");
    }
    ...
    protected void process(EventHeader event) {
        ...
        */
        ...
        //Process() copied from ReconParticleDriver.java, but with slight
        //modification, to use new makeReconstructedParticleMethod for new
        //track-to-cluster matching

        //super.process(event);   //No longer call super process....is this
        //okay? Will miss any updates to ReconParticleDriver.process()
        ...
        for (ReconstructedParticle positron : goodPositrons) {
            for (ReconstructedParticle electron : goodElectrons) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    System.out.println("HpsReconParticleDriver2019::makeV0Candidates fails:: skipping ele/pos pair.");
                    continue;
                }
            }
        }
