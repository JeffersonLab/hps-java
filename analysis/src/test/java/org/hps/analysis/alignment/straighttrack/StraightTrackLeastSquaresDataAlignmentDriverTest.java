 ...
 * @author ngraf
 */
public class StraightTrackLeastSquaresDataAlignmentDriverTest extends TestCase {

    public void testIt() throws Exception {
        FileCache cache = new FileCache();
        int nEvents = 10;
        LCSimLoop loop = new LCSimLoop();
        loop.add(new StraightTrackLeastSquaresDataAlignmentDriver());
        String fileName = "/hpsForwardFullEnergyElectrons_z-2338_bottom_0_SLIC-v06-00-00_QGSP_BERT_HPS-PhysicsRun2016-Nominal-v5-0-nofield_recon_ST.slcio";
