...
//            Hep3Vector atEcal = TrackUtils.getTrackPositionAtEcal(stateAtEcal);
        ...
        // shared at ECal
        if (doTrkExtrap) {
            Hep3Vector atEcalShared = TrackUtils.getTrackPositionAtEcal(baseTrackStateShared);
