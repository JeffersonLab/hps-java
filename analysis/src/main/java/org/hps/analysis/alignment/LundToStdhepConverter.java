...
public class LundToStdhepConverter {
 ...
 /* 201+   - reserved for users */
        ...
        try {
            ...
            while ((thisLine = myInput.readLine()) != null) {
                ...
                for (int i = 0; i < nParticles; ++i) {
                    ...
                    mom[1] = values[7];
                    pos[2] = values[13] * 10.;//convert cm to mm
                    mom[2] = values[8];
    ...
    public static void usage() {
        ...
        System.out.println("Usage: \n\n >> java LundToStdhepConvertor InputFile.txt <output directory> \n");
        ...
        System.out.println("\n e.g. >> java LundToStdhepConvertor LundEvents.txt \n");
        System.out.println("  will convert the events in LundEvents.txt to LundEvents.stdhep in the same directory");
        System.exit(0);
    }
}
