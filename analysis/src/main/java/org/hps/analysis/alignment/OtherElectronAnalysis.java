 ...
 * @author Norman Graf
 */
public class OtherElectronAnalysis extends Driver {

    boolean debug = true;
    private AIDA aida = AIDA.defaultInstance();

    private String finalStateParticlesColName = "OtherElectrons";
...
//        }
        ...
        // only keep events with one and only one electron
                ...
                if (isTopTrack(t)) {
                    ...
                    if (nHits == 5) {
                        ...
                        if (keepit) {
                            ...
                            aida.profile1D("Fee tight bottom 6-hit track thetaY vs z0 profile", 10, -0.054, -0.024).fill(thetaY, z0);
                            aida.histogram2D("Fee tight bottom 6-hit track thetaY vs z0", 100, -0.055, -0.015, 100, -0.6, 0.6).fill(thetaY, z0);
                        }
                    }
                }
                if (_alignit) {
