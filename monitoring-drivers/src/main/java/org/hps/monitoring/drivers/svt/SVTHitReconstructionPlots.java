...
public class SVTHitReconstructionPlots extends Driver {
    ...
    protected void detectorChanged(Detector detector) {
         ...
         * clposVsStrip[module][layer] = aida.histogram2D(sensor.getName() + "_cluster_vs_strip", 128, 0, 640, 100, -50,
         * 50);
    ...
    public void process(EventHeader event) {
        ...
        for (SiTrackerHitStrip1D cluster : stripHits) {
            ...
            SiTrackerIdentifierHelper _sid_helper = (SiTrackerIdentifierHelper) raw.getDetectorElement()
                    .getIdentifierHelper();
    ...
    private int computePlotterRegion(SiSensor sensor) {
        ...
        int region = ix * 4 + iy;
        // System.out.println(sensor.getName() + "; lyr=" + layer + "; mod=" + module + " -> xy[" + ix + "][" + iy +
        // "] -> reg="+region);
        return region;
    }
}
