...
public class HoleCreationDriver extends Driver {
    ...
    private void createHoles(Track trk) {
        ...
        while (iter.hasNext()) {
            ...
            List<RawTrackerHit> rawHits = (List<RawTrackerHit>) hit
                    .getRawHits();
    ...
    protected void loadCollections(EventHeader event) {
        ...
        inputTrackHitCollection = event.get(TrackerHit.class,
                inputTrackHitCollectionName);
        inputRawTrackHitCollection = event.get(RawTrackerHit.class,
                inputRawTrackHitCollectionName);
        inputHelicalTrackHitCollection = event.get(HelicalTrackHit.class,
                inputHelicalTrackHitCollectionName);
        inputRHelicalTrackHitCollection = event.get(HelicalTrackHit.class,
    ...
    protected void putCollections(EventHeader event) {
        ...
        event.put(outputHelicalTrackHitCollectionName,
                inputHelicalTrackHitCollection);
        event.put(outputRHelicalTrackHitCollectionName,
