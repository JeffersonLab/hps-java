...
//e cuts 3430
/*
double[] ecuttopmin={1.4,1.5,1.55,1.6,1.65,1.65};
double[] ecuttopmax={1.8,1.85,1.9,1.95,2,2};

double[] ecutbotmin= {1.45,1.5,1.5,1.6,1.6,1.6};
double[] ecutbotmax={1.75,1.85,1.9,2,2,2};
...
//e cuts 3434
/*
double[] ecuttopmin={1.25,1.45,1.5,1.5,1.65,1.63};
double[] ecuttopmax={1.55,1.8,1.9,1.95,2,2};

double[] ecutbotmin= {1.27,1.32,1.37,1.52,1.6,1.6};
double[] ecutbotmax={1.7,1.8,1.77,1.9,2,2};
...
double[] ecuttopmin={1.3,1.35,1.45,1.50,1.60,1.60};
double[] ecuttopmax={1.6,1.80,1.90,1.95,2.00,2.00};

double[] ecutbotmin= {1.27,1.3,1.3,1.5,1.6,1.6};
double[] ecutbotmax={1.7,1.8,1.8,2,2,2};
