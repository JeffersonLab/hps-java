...
public class Pair<T, S> implements Comparable<Pair<T, S>> {
     ...
     * Default constructor
     * 
     * @param firstElement The first element in the pair
     * @param secondElement The second element in the pair
     */
     ...
     * 
     * @return firstElement The first element in the pair
     */
     ...
     * 
     * @return secondElement The second element in the pair
     */
     ...
     * @return returns 0, 1 or -1 if the hash code of the pair is equal, greater than or less than the specified pair
     */
    @Override
     ...
     * 
     * @param obj The pair to compare to
    ...
    public boolean equals(Object obj) {
        ...
        if (obj.getClass() == Pair.class) {
            ...
            if (this.secondElement != pair.secondElement
                    && (this.secondElement == null || !this.secondElement.equals(pair.secondElement)))
                return false;
        }
